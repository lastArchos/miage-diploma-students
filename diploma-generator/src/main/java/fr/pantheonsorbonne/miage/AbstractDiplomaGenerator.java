...
public abstract class AbstractDiplomaGenerator implements DiplomaGenerator {
	 ...
	 */
	@Override
	public InputStream getContent()  throws GenerationException{
		...
		try (ByteArrayOutputStream bos = new ByteArrayOutputStream();) {
			...
			throw new GenerationException("failed to generate the file to stream to");
		}

	}

	protected void writeToStream(OutputStream os) throws GenerationException {
